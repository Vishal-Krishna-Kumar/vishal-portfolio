...
const Preloader = () => {
    ...
    return (
        <div className="fixed inset-0 z-[6] flex" ref={preloaderRef}>
            ...
            <p className="name-text flex text-[13vw] lg:text-[130px] font-anton text-center absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 leading-none overflow-hidden">
                ...
                {/* <span className="inline-block translate-y-full" style={{ width: '2ch' }}>&nbsp;</span> */}
                ...
                <span className="inline-block translate-y-full">A</span>
                {/* <span className="inline-block translate-y-full" style={{ width: '1ch' }}>&nbsp;</span> */}
